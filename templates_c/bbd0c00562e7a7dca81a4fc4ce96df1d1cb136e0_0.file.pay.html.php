...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <form action="pay.php" method="POST" id="pay_form" role="form">
      ...
      <div class="transport_method">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <label>
                <input type="text" id="buyer_name" name="buyer_name" placeholder="請輸入中文姓名" required />
              </label>
            </div>
          </div>
          <div class="col-sm-12">
      ...
      <div class="coupon_method">
        ...
        <div class="form-group">
          <label class="radio-inline">
            <input type="radio" name="coupon_options" id="couponRadio1" value="option1" onclick="acceptCoupon(1)" />
            使用
          </label>
          <label class="radio-inline">
            <input type="radio" name="coupon_options" id="couponRadio2" value="option2" onclick="acceptCoupon(2)"
              checked />
            不使用
          </label>
        </div>
          <div class="form-group">
            <input type="text" class="form-control" id="couponCode" style="display: none" placeholder="請輸入優惠券代碼" />
      ...
      <div class="receipt_method">
        ...
        <div class="form-group">
          ...
          <label class="radio-inline">
            <input type="radio" name="invoice_options" id="invoiceRadio2" value="option2" onclick="chooseInvoice(2)" />
            三聯式發票
          </label>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="carrier" name="carry" placeholder="請輸入載具號碼"
        ...
        <div class="row">
          <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="vat" name="company" placeholder="請輸入統一編號" maxlength="8"
      ...
      <div class="confirm_buy">
        <nav class="navbar navbar-default">
          <div class="container">
            ...
            <input type="submit" class="btn btn-warning navbar-btn navbar-right" style="width: 100px;" value="結帳">
          </div>
        </nav>
      </div>
    </form>
